...
export default function contact() {
    ...
    async function sendContact(event: any) {
        const response = await fetch("/api/grievence/contact", {
            method: "POST",
            ...
            <div className="container mx-auto flex flex-col items-center justify-center px-5 py-24">
                <div className="flex w-full flex-col items-center text-center md:w-2/3">
                    ...
                    <p className="mb-8 leading-relaxed text-white">
                        ...
                        <form className="w-full" action={sendContact}>
                            ...
                            <div className="relative mr-4 w-2/4 text-left md:w-full lg:w-full xl:w-1/2">
                                ...
                                <button type="submit" className="inline-flex flex-shrink-0 rounded border-0 bg-orange-600 px-6 py-4 text-lg font-semibold text-white transition hover:ring-2 hover:ring-orange-400 focus:outline-none">Send</button>
                            </div>
                        </form>
                    {error && (
